                ...
                <div className="vhome_row">
                  <table>
                    ...
                    {this.state.to.map((o) => {
                      return (
                        <tr>
                          <td name="vid" value={this.state.vid}>
                            {o.vid}
                          </td>
                          <td>{o.vuid}</td>
                          <td>{o.vfname}</td>
...
>>>>>>> abc96dfe1062a237c3712849975694ac12d895d2
                </div>
              </div>
            </div>
          ) : (
            <div style={{ textAlign: 'center', color: 'black' }}>
              <h2>No New Vendor Register</h2>
            </div>
          )}
        </div>
        <div>
                      ...
                      return (
                        <tr>
                          ...
                          <td>
                            <button
                              onClick={() => {
                                this.accept1(o1.pid, o1.pprice, o1.pqty)
                              }}
                            >
                              Approve
                            </button>
                          ...
                          <td>
                            <button
                              onClick={() => {
                                this.deny1(o1.pid, o1.pprice, o1.pqty)
                              }}
                            >
                              Deny
                            </button>
